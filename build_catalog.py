...
PUBLICATION_MAP = {
    ...
    # --- Y ---
    "YA": "Ya",
    # --- Additional variants found in corpus ---
    "ALHAMA": "Alhama",
    "ARAGONEXPRESS": "Aragón Express",
    "ARDE": "Arde",
    "ATLÁNTICO": "Atlántico",
    "ATLANTICA XXII": "Atlántica XXII",
    "ATLANTICA": "Atlántica XXII",
    "BLANCO Y NEGRO": "Blanco y Negro",
    "BOG AGT": "Blog AGT",
    "DIARIO DLERIDA": "Diario de Lérida",
    "DIARIO ESPAÑOL": "Diario Español",
    "DIARIOESPAÑOL": "Diario Español",
    "DIARIODEBURGOS": "Diario de Burgos",
    "DIARIOELAGUIJON": "Diario El Aguijón",
    "DISENSO": "Disenso",
    "EL AULLIDO DEL LOBO": "El Aullido del Lobo",
    "EL CORRREO ESPAÑOL": "El Correo Español",
    "ELDIARIODELSIGLOXX": "El Diario del Siglo XX",
    "ELPUEBLOGALLEGO_CELA": "El Pueblo Gallego",
    "ESTAFETA LITERARIA": "Estafeta Literaria",
    "EXPANSION": "Expansión",
    "FIERA LITERARIA": "Fiera Literaria",
    "HERMANO LOBO": "Hermano Lobo",
    "HOJADLUNES": "Hoja del Lunes",
    "HOJADLUNESBCN": "Hoja del Lunes de Barcelona",
    "L'HORA DE CATALUNYA": "L'Hora de Catalunya",
    "LA BULLA": "La Bulla",
    "LA CODORNIZ": "La Codorniz",
    "LACODORNIZ": "La Codorniz",
    "LA JORNADA": "La Jornada",
    "LA PROVINCA": "La Provincia",
    "LA REPÚBLICA DE LOS ESTUDIANTES": "La República de los Estudiantes",
    "LAPAGINADEFINITIVA": "La Página Definitiva",
    "LAVERDADMURCIA": "La Verdad de Murcia",
    "LEER": "Leer",
    "LOS SITIOS": "Los Sitios",
    "LUI": "Lui",
    "MEMORIA Y REPUBLICA": "Memoria y República",
    "NOTICIASINTERESANTES": "Noticias Interesantes",
    "PANORAMA INTERNACIONAL": "Panorama Internacional",
    "PLAY LADY": "Play Lady",
    "PSICOLOGIA POLITICA": "Psicología Política",
    "RENOVACION": "Renovación",
    "REVISTA LEER": "Leer",
    "RUEDO IBERICO": "Ruedo Ibérico",
    "SÁBADO GRÁFICO": "Sábado Gráfico",
    "SABADO GRAFICO": "Sábado Gráfico",
    "TIME": "Time",
    "VALENCIA SEMANAL": "Valencia Semanal",
    "LA VOZPERIODISTICA": "La Voz Periodística",
    "DIARODBURGOS": "Diario de Burgos",
    "ES": "ES",
    "LAVOZDASTURIAS": "La Voz de Asturias",
    "LA PRENSA ALCAREÑA": "La Prensa Alcareña",
    "LA PRENSA ALCARREÑA": "La Prensa Alcareña",
    "NUEVOS HORIZONTES": "Nuevos Horizontes",
    "FILOSOFIA GIGITAL": "Filosofía Digital",
}
